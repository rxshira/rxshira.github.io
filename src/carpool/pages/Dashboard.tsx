...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-black text-white font-sans overflow-hidden text-white">
      {/* Navigation */}
      ...
      <div className="flex border-b border-white/10 shrink-0 z-20 bg-[#050505]">
        {[
          ...
          <div key={i} className="flex-1 p-3 px-5 border-r border-white/10 text-white">
      ...
      <div className="flex flex-1 overflow-hidden z-10">
        <aside className="w-[280px] border-r border-white/10 flex flex-col shrink-0 bg-[#0c0c0c]">
          <div className="p-3 px-4 border-b border-white/10 shrink-0">
            ...
            <div className="text-[10px] font-mono text-pink uppercase tracking-widest mb-1 px-1">Roster</div>
          </div>
        ...
        <main className="flex-1 relative overflow-hidden bg-[#050505]">
            ...
            <MapView 
              markers={allUsers.filter(u => u.preferred_arrival_time === viewArrivalTime).map(m => {
                ...
                return { 
                  ...
                  isMatched: !!pool, 
                  isFull, 
                  isSelected: myCarpool?.member_ids.includes(m.id) || activeMenuId === m.id || focusedUserId === m.id
                };
              })}
          ...
          <div className="absolute top-4 right-4 bg-black/85 border border-white/10 backdrop-blur-xl p-3 px-4 rounded-lg z-20 space-y-2.5 shadow-2xl">
            <h4 className="text-[9px] font-mono text-pink uppercase tracking-widest mb-1.5 font-bold text-white">Map Legend</h4>
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2.5 text-[10px] text-white/40 border-t border-white/5 pt-2 mt-1"><div className="w-2.5 h-2.5 rounded-full bg-white/60 shadow-sm" /> <span>Matched / Full (Filled)</span></div>
              ...
              <div className="flex items-center gap-2.5 text-[10px] text-white/40 border-t border-white/5 pt-2"><div className="w-2.5 h-2.5 rounded-[2px] bg-[#1f6abf] flex items-center justify-center text-[5px] font-bold text-white uppercase shadow-sm">IBM</div> <span>SVL (Office)</span></div>
            </div>
                    ...
                    return (
                      <div key={req.id} className="bg-white/5 p-3 border border-white/5 rounded-sm">
                        ...
                        {req.status === 'pending' && <div className="flex gap-2 mt-3">
                          ...
                          <button className="flex-1 py-1.5 border border-white/10 text-white/40 text-[9px] font-bold uppercase rounded-sm hover:text-white hover:bg-white/5">Ignore</button>
                        </div>}
                      </div>
                    );
                  })}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 flex-wrap text-white">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-7 h-7 rounded-[3px] bg-[#1f6abf]/20 border border-[#1f6abf]/50 flex items-center justify-center text-[7px] font-bold text-[#5ba3e8] uppercase shadow-sm">IBM</div>
